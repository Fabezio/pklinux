...
<svelte:head>
  <title>Terminal | exercices</title>
</svelte:head>
<h1>Terminal : Exercices</h1>
<section id="learn">
  ...
  <p>
    a présent vous allez afficher les fichiers présents dans le répertoire
    courant via
    <i>ls</i>:
  </p>
  <Code instruction="ls">
  ...
  <p>
    ...
    quoi servent ces extensions. Celle que vous avez utilisée précedemment est
    un
    <q>raccourci</q>
  ...
  <p>
    <q>OK mais il se passe quoi en cas d'erreur?</q>
